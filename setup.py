...
NAME = 'clusgan'
DESCRIPTION = 'A PyTorch Implementation of ClusterGAN',
MAINTAINER = 'Zigfried Hampel-Arias'
MAINTAINER_EMAIL = 'zhampel.github@gmail.com'
URL = 'https://github.com/zhampel/clusterGAN'
LICENSE = 'MIT'
...
about = {}
with io.open(os.path.join(here, 'clusgan', '__version__.py'), encoding='utf-8') as f:
    exec(f.read(), about)
